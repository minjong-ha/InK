...
/* keyvalue/keyvalue.c  */
asmlinkage long sys_btree_insert(char __user *key, size_t key_len, char __user *value, size_t value_len);
asmlinkage long sys_btree_search(char __user *key, size_t key_len);
asmlinkage long sys_btree_remove(char __user *key, size_t key_len);
asmlinkage long sys_ink_init(void);
asmlinkage long sys_ink_load(void);
